...
class VideoLiveNetworkWidget extends StatefulWidget {
  final String url;

   VideoLiveNetworkWidget(this.url);

  @override
  VideoLiveNetworkWidgetState createState() => VideoLiveNetworkWidgetState();
}

class VideoLiveNetworkWidgetState extends State<VideoLiveNetworkWidget> {
